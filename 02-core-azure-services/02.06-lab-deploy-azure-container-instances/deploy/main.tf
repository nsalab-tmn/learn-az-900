...
# resource "azurerm_resource_group_policy_assignment" "allowed-ostype-assignment" {
#   name                 = "policy-ostype-assignment-${var.tp_name}-${var.instance_id}"
#   resource_group_id    = azurerm_resource_group.learn.id
#   policy_definition_id = azurerm_policy_definition.allowed-ostype-definition.id
# }
